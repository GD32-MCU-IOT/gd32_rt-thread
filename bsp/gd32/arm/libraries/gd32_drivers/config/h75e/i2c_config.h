 ...
 * Change Logs:
 * Date           Author       Notes
 * 2026-04-21     RT-Thread    first implementation for GD32H75E I2C DMA
 */
...
/* This configuration set provides the custom I2C DMA helper implementation for H75E.
 * H75E uses DMAMUX with 'request' field instead of 'subperiph'. */
