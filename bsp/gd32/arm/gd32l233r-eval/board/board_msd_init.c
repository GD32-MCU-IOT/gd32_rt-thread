...
void gd32_i2c_gpio_init(const struct gd32_i2c_bus *i2c)
{
    ...
    case I2C0:
        /* enable I2C0 GPIO clock: PB6(SCL,AF4), PB7(SDA,AF4) [GD32L233 Datasheet] */
    ...
    case I2C1:
        /* enable I2C1 GPIO clock: PB10(SCL,AF4), PB11(SDA,AF4) [GD32L233 Datasheet] */
        rcu_periph_clock_enable(RCU_GPIOB);
    ...
    case I2C2:
        /* enable I2C2 GPIO clock: PC0(SCL,AF4), PC1(SDA,AF4) [GD32L233 Datasheet] */
...
void gd32_spi_init(struct gd32_spi *gd32_spi)
{
    ...
    case SPI0:
        /* WARNING: Due to pin sharing conflict, SPI0 and UART4 cannot be enabled simultaneously.
         * SPI0 CS (PD2) conflicts with UART4 RX (PD2). Enable only one peripheral at runtime
         * to avoid communication errors and garbled data transmission.
         */
        /* enable SPI0 GPIO clock: PB3(SCK), PB4(MISO), PB5(MOSI), CS controlled by software */
        rcu_periph_clock_enable(RCU_GPIOB);
    ...
    case SPI1:
        /* enable SPI1 GPIO clock: PB13(SCK,AF6), PB14(MISO,AF6), PB15(MOSI,AF6) [GD32L233 Datasheet] */
        rcu_periph_clock_enable(RCU_GPIOB);

        /* GPIO pin configuration: AF6 for SPI1 */
...
void gd32_uart_gpio_init(struct gd32_uart *uart)
{
    ...
    case UART3:
        /* enable UART3 GPIO clock: PC10(TX,AF7), PC11(RX,AF7) [GD32L233 Datasheet] */
        rcu_periph_clock_enable(RCU_GPIOC);

        /* GPIO pin configuration: AF7 for UART3 */
    ...
    case UART4:
        /* WARNING: Due to pin sharing conflict, UART4 and SPI0 cannot be enabled simultaneously.
         * UART4 RX (PD2) conflicts with SPI0 CS (PD2). Enable only one peripheral at runtime
         * to avoid communication errors and garbled data transmission.
         */
        ...
        /* GPIO pin configuration: AF7 for UART4 */
