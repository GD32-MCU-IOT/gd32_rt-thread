 ...
 * Change Logs:
 * Date           Author       Notes
 * 2026-04-21     RT-Thread    first implementation for GD32H7xx I2C DMA
 */
...
/* This configuration set provides the custom I2C DMA helper implementation for H7xx.
 * H7xx uses DMAMUX with 'request' field instead of 'subperiph'. */
