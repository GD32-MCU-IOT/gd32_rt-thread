...
/*
 * DMA Channel Allocation Table for GD32H75E:
 * ============================================================
 * DMA0 Channel0 - UART0_RX
 * DMA0 Channel1 - UART0_TX
 * DMA0 Channel2 - UART1_RX / I2C2_RX (conflict)
 * DMA0 Channel3 - UART1_TX / I2C2_TX (conflict)
 * DMA0 Channel4 - UART2_RX / SPI5_RX / I2C3_RX (conflict)
 * DMA0 Channel5 - UART2_TX / SPI5_TX / I2C3_TX (conflict)
 * DMA0 Channel6 - SPI0_RX
 * DMA0 Channel7 - SPI0_TX
 * ------------------------------------------------------------
 * DMA1 Channel0 - SPI1_RX / UART3_RX (conflict)
 * DMA1 Channel1 - SPI1_TX / UART3_TX (conflict)
 * DMA1 Channel2 - SPI2_RX
 * DMA1 Channel3 - SPI2_TX
 * DMA1 Channel4 - SPI3_RX / I2C0_RX (conflict)
 * DMA1 Channel5 - SPI3_TX / I2C0_TX (conflict)
 * DMA1 Channel6 - SPI4_RX / I2C1_RX (conflict)
 * DMA1 Channel7 - SPI4_TX / I2C1_TX (conflict)
 * ============================================================
...
#define I2C3_DMA_RX_IRQHandler           DMA0_Channel4_IRQHandler
...
#define I2C3_RX_DMA_IRQ                  DMA0_Channel4_IRQn
#endif
...
#define I2C3_DMA_TX_IRQHandler           DMA0_Channel5_IRQHandler
...
#define I2C3_TX_DMA_IRQ                  DMA0_Channel5_IRQn
#endif
