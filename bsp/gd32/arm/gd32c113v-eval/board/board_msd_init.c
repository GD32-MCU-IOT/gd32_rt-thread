...
/**
  ...
  * @param  i2c
  * @retval None
  * @note   GD32C113V only supports I2C0 and I2C1. Other I2C configurations are kept for code compatibility.
  */
...
* @retval None
* @note  GD32C113V only supports SPI0 and SPI1. Other SPI configurations are kept for code compatibility.
*/
...
* @retval None
* @note  GD32C113V supports USART0, USART1, UART3, UART4. Other UART configurations are kept for code compatibility.
*/
void gd32_uart_gpio_init(struct gd32_uart *uart)
{
    ...
    case UART3:
        ...
        /* GPIO pin configuration: UART3_TX(PC10), UART3_RX(PC11) */
    ...
    case UART4:
        ...
        /* GPIO pin configuration: UART4_TX(PC12), UART4_RX(PD2) */
