...
if PLATFORM == 'gcc':
    ...
    DEVICE = ' --specs=nano.specs -mcpu=cortex-m4 -mthumb -mfpu=fpv4-sp-d16 -mfloat-abi=soft -ffunction-sections -fdata-sections'
    CFLAGS = DEVICE + ' -Dgcc -DGD32F350'
    ...
    DEVICE = ' --cpu Cortex-M4.no_dsp '
    CFLAGS = ' --target=arm-arm-none-eabi -mcpu=cortex-m4+nodsp '
    ...
    # Use raw string for Windows backslashes to avoid escape warnings
