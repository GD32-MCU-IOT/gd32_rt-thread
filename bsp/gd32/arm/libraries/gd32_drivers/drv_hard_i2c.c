...
#define IS_I2C_LEGACY(periph)  ((periph) == I2C0 || (periph) == I2C1 || (periph) == I2C2)
   ...
   || defined (SOC_SERIES_GD32C11x) || defined (SOC_SERIES_GD32E23x)
...
//    rt_err_t result;
 ...
 || defined (SOC_SERIES_GD32E23x)
        ...
        {
#if defined (SOC_SERIES_GD32F5xx) || defined (SOC_SERIES_GD32H7xx) || defined (SOC_SERIES_GD32H75E) \
 || defined (SOC_SERIES_GD32G5x3) || defined (SOC_SERIES_GD32H77x) || defined (SOC_SERIES_GD32L23x) \
 || defined (SOC_SERIES_GD32E51x) || defined (SOC_SERIES_GD32F50x) || defined (SOC_SERIES_GD32M53x)
