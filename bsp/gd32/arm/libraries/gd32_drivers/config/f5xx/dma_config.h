...
#define I2C1_DMA_TX_IRQHandler          DMA0_Channel5_IRQHandler
#define I2C1_TX_DMA_RCC                 RCU_DMA0
#define I2C1_TX_DMA_INSTANCE            DMA0
#define I2C1_TX_DMA_CHANNEL             DMA_CH5
#define I2C1_TX_DMA_IRQ                 DMA0_Channel5_IRQn
