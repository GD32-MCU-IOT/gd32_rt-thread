 ...
 * 2026-08-12     RT-Thread    adjust pins/peripheral selection for GD32E503V-EVAL
 */
...
/* LED pins - GD32E503V-EVAL board
 * LEDPWR = power indicator, LED1 = PC0, LED2 = PC2, LED3 = PE0, LED4 = PE1
 */
