...
#ifndef PHY_ADDRESS_1
#define PHY_ADDRESS_1 ((uint16_t)2U)
#endif
#endif
...
/* for GD32 series that only have one Ethernet port */
#ifndef ENET0
#define ENET0 ENET
#define ENET0_IRQn ENET_IRQn
#define RCU_ENET0 RCU_ENET
#define RCU_ENET0TX RCU_ENETTX
#define RCU_ENET0RX RCU_ENETRX
#define ENET0_IRQHandler ENET_IRQHandler
#define GD32_ENET_MAC_CFG(enetx) ENET_MAC_CFG

#define enet_deinit(enetx) enet_deinit()
#define enet_init(enetx, mediamode, checksum, recept) enet_init(mediamode, checksum, recept)
#define enet_software_reset(enetx) enet_software_reset()
#define enet_txfifo_flush(enetx) enet_txfifo_flush()
#define enet_phy_write_read(enetx, direction, phy_address, phy_reg, pvalue) enet_phy_write_read(direction, phy_address, phy_reg, pvalue)
#define syscfg_enet_phy_interface_config(enetx, phy_interface) syscfg_enet_phy_interface_config(phy_interface)
#else
#define GD32_ENET_MAC_CFG(enetx) ENET_MAC_CFG(enetx)
#endif
...
typedef enet_descriptors_struct EMAC_DMADESCTypeDef;
// #else
// typedef struct
// {
...
#define EMAC_REGS(enet_periph)         ((struct rt_synopsys_eth *)(enet_periph))
