 ...
 * Change Logs:
 * Date           Author       Notes
 * 2024-08-07     RT-Thread    first implementation for GD32C113V-EVAL
 */
...
/* Note: GD32C113V-EVAL supports SPI Flash (GD25Q40) on SPI0 (PA5/PA6/PA7).
 *       CS pin is PA4.
 */
...
#define LED2_PIN    GET_PIN(C, 2)   /* LED2 on PC1 */
#define LED3_PIN    GET_PIN(E, 0)   /* LED3 on PC2 */
#define LED4_PIN    GET_PIN(E, 1)   /* LED4 on PC3 */
...
int main(void)
{
    ...
    rt_kprintf("Hello GD32C113V-EVAL!\n");
