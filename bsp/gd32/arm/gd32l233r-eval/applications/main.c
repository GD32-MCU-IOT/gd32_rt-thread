...
/* LED pins - GD32L233R-EVAL board */
#define LED2_PIN    GET_PIN(C, 7)
#define LED3_PIN    GET_PIN(C, 8)
#define LED4_PIN    GET_PIN(C, 9)
#define LED5_PIN    GET_PIN(C, 11)
...
#define SPI_CS_PIN       GET_PIN(D, 2)
#define SPI_TEST_SIZE    200
