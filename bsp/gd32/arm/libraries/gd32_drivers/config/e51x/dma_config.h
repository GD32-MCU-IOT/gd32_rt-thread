...
/*
 * DMA Channel Allocation Table for GD32E51x (from UM Table 11-3 / 11-4):
 * GD32E51x has standard DMA — NO DMAMUX, channels are hard-wired to peripherals.
 * ============================================================
...
/* DMA1 Channel4 - UART3_TX / USART5_TX (conflict) */
...
#define UART5_TX_DMA_IRQ                DMA1_Channel4_IRQn
#endif
