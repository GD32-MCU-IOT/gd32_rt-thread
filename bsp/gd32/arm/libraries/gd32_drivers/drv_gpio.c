...
static rt_err_t gd32_pin_irq_enable(struct rt_device *device, rt_base_t pin, rt_uint8_t enabled)
{
...
#if defined SOC_SERIES_GD32F4xx || defined SOC_SERIES_GD32H7xx || defined SOC_SERIES_GD32F5xx || defined SOC_SERIES_GD32H75E || defined (SOC_SERIES_GD32G5x3)|| defined (SOC_SERIES_GD32G5x3)
 ...
 || defined SOC_SERIES_GD32L23x || defined SOC_SERIES_GD32H75E || defined (SOC_SERIES_GD32G5x3)
        ...
        exti_init((exti_line_enum)(index->pin_src), EXTI_INTERRUPT, trigger_mode);
        exti_interrupt_flag_clear((exti_line_enum)(index->pin_src));
#else
