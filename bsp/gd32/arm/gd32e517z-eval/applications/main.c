 ...
 * 2026-06-08     RT-Thread    adjust pins/peripheral selection for GD32E517Z-EVAL
 */
...
/* LED pins - GD32E517Z-EVAL board
 * LED1 = PG10, LED2 = PG11, LED3 = PG12, LED4 = PG13
 */
#define LED1_PIN    GET_PIN(G, 10)
#define LED2_PIN    GET_PIN(G, 11)
#define LED3_PIN    GET_PIN(G, 12)
#define LED4_PIN    GET_PIN(G, 13)
