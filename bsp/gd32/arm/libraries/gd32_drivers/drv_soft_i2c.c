...
#if !defined(BSP_USING_SOFT_I2C0) && !defined(BSP_USING_SOFT_I2C1) && !defined(BSP_USING_SOFT_I2C2) && !defined(BSP_USING_SOFT_I2C3)
...
static const struct gd32_soft_i2c_config soft_i2c_config[] =
{
    ...
    I2C0_BUS_SOFT_CONFIG,
#endif
#ifdef BSP_USING_SOFT_I2C1
    I2C1_BUS_SOFT_CONFIG,
#endif
#ifdef BSP_USING_SOFT_I2C2
    I2C2_BUS_SOFT_CONFIG,
#endif
#ifdef BSP_USING_SOFT_I2C3
    I2C3_BUS_SOFT_CONFIG,
#endif
};

static struct gd32_sw_i2c i2c_obj[sizeof(soft_i2c_config) / sizeof(soft_i2c_config[0])];
...
/**
  ...
  * @retval None
  */
static void gd32_i2c_gpio_init(struct gd32_sw_i2c *i2c)
{
...
{
    rt_size_t obj_num = sizeof(i2c_obj) / sizeof(struct gd32_sw_i2c);
