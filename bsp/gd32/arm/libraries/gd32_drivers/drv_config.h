...
#elif defined(SOC_SERIES_GD32F5HC)
#include "config/f5hc/dma_config.h"
#include "config/f5hc/uart_config.h"
#include "config/f5hc/spi_config.h"
#include "config/f5hc/i2c_config.h"
