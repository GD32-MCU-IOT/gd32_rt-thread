...
static void gd32_pin_mode(rt_device_t dev, rt_base_t pin, rt_uint8_t mode)
{
 ...
 || defined SOC_SERIES_GD32F3x0 || defined SOC_SERIES_GD32F50x || defined SOC_SERIES_GD32G5x3 \
 || defined SOC_SERIES_GD32H77x || defined SOC_SERIES_GD32M53x || defined SOC_SERIES_GD32F5HC \
 ...
 || defined SOC_SERIES_GD32E23x || defined SOC_SERIES_GD32L23x || defined SOC_SERIES_GD32H75E \
 || defined SOC_SERIES_GD32F3x0 || defined SOC_SERIES_GD32F50x || defined SOC_SERIES_GD32G5x3 \
 || defined SOC_SERIES_GD32H77x || defined SOC_SERIES_GD32F5HC
...
#elif defined SOC_GD32F5HC
    gpio_mode_set(index->gpio_periph, pin_mode, pin_pupd, index->pin);
    if(pin_mode == GPIO_MODE_OUTPUT)
    {
        gpio_output_options_set(index->gpio_periph, pin_odpp, GPIO_OSPEED_166MHZ, index->pin);
    }
...
#if defined SOC_SERIES_GD32E23x || defined SOC_SERIES_GD32L23x
