...
if PLATFORM == 'gcc':
    ...
    # Cortex-M33 with single-precision FPU
    DEVICE = ' -mcpu=cortex-m33 -mthumb -mfpu=fpv5-sp-d16 -mfloat-abi=soft -ffunction-sections -fdata-sections'
    CFLAGS = DEVICE + ' -Dgcc -DGD32E51X'
